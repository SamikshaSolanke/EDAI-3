...
def get_candidate_name(text):
    ...
    # Generate the content to extract the candidate's name
    name_res = modelai.generate_content("Analyze the following text and extract the candidate's full name and give the Full name of the candidate only as your response: " + text)

    candidate_name = textwrap.indent(name_res.text, "• ")
